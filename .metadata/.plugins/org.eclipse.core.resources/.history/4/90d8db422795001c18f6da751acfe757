			...
			<div class="container-fluid">
				...
				<div class="d-flex justify-content-end">
					...
					<div class="dropdown mr-2">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
							<a class="dropdown-item" href="myinfo.jsp">내정보관리</a> <a
					...
					<form action="<%=request.getContextPath()%>/register" method="post">
						...
						<div class="form-group">
							<label for="password">비밀번호</label> <input type="text"
								name="password" id="password" required value="${password}"><br>
						</div>
						<div class="form-group">
							<label for="name">이름</label> <input type="text" name="name"
								id="name" required value="${name}"><br>
						</div>
						<div class="form-group">
							<label for="email">이메일</label> <input type="text" name="email"
								id="email" required value="${email}"><br>
						</div>
						<div class="form-group">
							<label for="phone">휴대폰번호</label> <input type="text" name="phone"
								id="phone" required value="${phone}"><br>
						</div>
						<div class="form-group">
							<label for="address">주소</label> <input type="text" name="address"
								id="address" required value="${address}"><br>
						</div>
